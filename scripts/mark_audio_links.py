...
EXTRA_SPANISH = {
    "que", "de", "no", "el", "la", "los", "las", "un", "una", "unos", "unas",
    "y", "en", "lo", "por", "para", "con", "sin", "sobre", "entre", "hasta",
    "desde", "hacia", "según", "durante", "contra", "mediante", "vía",
    "me", "te", "se", "nos", "os", "le", "les",
    "mi", "tu", "su", "mis", "tus", "sus", "mío", "mía", "tuyo", "suyo",
    "yo", "tú", "él", "ella", "usted", "nosotros", "nosotras", "vosotros",
    "vosotras", "ellos", "ellas", "ustedes", "ello", "mí", "ti",
    "ser", "estar", "haber", "tener", "hacer", "ir", "venir", "decir", "poder",
    "querer", "saber", "ver", "dar", "poner", "salir", "llegar", "pasar",
    "deber", "dejar", "llevar", "encontrar", "seguir", "llamar",
    "pensar", "hablar", "tomar", "vivir", "sentir", "escribir", "leer",
    "comer", "beber", "dormir", "abrir", "cerrar", "buscar", "trabajar",
    "estudiar", "aprender", "enseñar", "comprar", "vender", "pagar", "usar",
    "necesitar", "gustar", "parecer", "conocer", "entender", "preguntar",
    "responder", "ayudar", "escuchar", "mirar", "esperar", "entrar",
    "subir", "bajar", "correr", "caminar", "viajar", "jugar", "ganar", "perder",
    "cambiar", "terminar", "empezar", "continuar", "intentar", "decidir",
    "creer", "recordar", "olvidar", "amar", "odiar",
    "casa", "hombre", "mujer", "niño", "niña", "padre", "madre", "hijo", "hija",
    "hermano", "hermana", "amigo", "amiga", "familia", "gente", "persona",
    "día", "noche", "mañana", "tarde", "hora", "tiempo", "año", "mes", "semana",
    "vez", "lugar", "mundo", "país", "ciudad", "pueblo", "calle",
    "agua", "pan", "leche", "café", "té", "vino", "cerveza", "comida", "cena",
    "libro", "escuela", "trabajo", "dinero", "problema", "nombre", "número",
    "color", "perro", "gato", "mesa", "silla", "puerta", "ventana", "coche",
    "sol", "luna", "mar", "río", "fuego", "tierra", "aire", "luz", "paz",
    "amor", "verdad", "vida", "muerte", "dios", "señor", "señora",
    "sí", "tal", "cada", "otro", "mismo", "todo", "nada", "algo",
    "alguien", "nadie", "mucho", "poco", "más", "menos", "muy", "tan", "tanto",
    "bien", "mal", "ya", "aún", "todavía", "siempre", "nunca", "ahora", "antes",
    "después", "luego", "entonces", "aquí", "allí", "ahí", "cerca", "lejos",
    "dentro", "fuera", "arriba", "abajo", "hoy", "ayer", "pronto",
    "temprano", "claro", "seguro", "importante", "posible", "fácil",
    "difícil", "grande", "pequeño", "bueno", "malo", "nuevo", "viejo", "joven",
    "feliz", "triste", "cansado", "ocupado", "listo", "primero", "último",
    "mejor", "peor", "mayor", "menor", "rojo", "azul", "verde", "negro", "blanco",
    "uno", "dos", "tres", "cuatro", "cinco", "seis", "siete", "ocho", "nueve",
    "diez", "cien", "mil", "lunes", "martes", "miércoles", "jueves", "viernes",
    "sábado", "domingo", "enero", "febrero", "marzo", "abril", "mayo", "junio",
    "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre",
    "qué", "quién", "dónde", "cuándo", "cómo", "cuál", "cuánto",
    "porque", "hola", "adiós", "gracias", "favor", "perdón", "permiso",
    "español", "inglés", "méxico", "españa", "texas", "estados", "unidos",
    "conmigo", "contigo", "consigo", "del", "al", "esto", "eso", "aquel",
    "esta", "ese", "esa", "estos", "esas", "aquella", "nuestro", "vuestra",
    "este",
    # cheat-sheet heavy hitters
    "hablo", "hablas", "habla", "hablamos", "hablan", "como", "comes", "come",
    "vivo", "vives", "vive", "soy", "eres", "somos", "son", "estoy", "estás",
    "está", "estamos", "están", "tengo", "tienes", "tiene", "tenemos", "tienen",
    "voy", "vas", "va", "vamos", "van", "puedo", "puedes", "puede", "podemos",
    "pueden", "quiero", "quieres", "quiere", "hago", "haces", "hace", "digo",
    "dices", "dice", "sé", "sabes", "sabe", "veo", "ves", "ve", "doy", "das",
    "da", "hay", "he", "has", "ha", "hemos", "han", "vengo", "vienes", "viene",
    "llego", "llegas", "llega", "llamo", "llamas", "llaman",
    "guerra", "guitarra", "queso", "aquí", "pingüino", "vergüenza", "cero",
    "cine", "gente", "jamón", "niño", "españa", "zapato", "examen", "familia",
    "ciudad", "baile", "bueno", "tiene", "muy", "hay", "gracias",
}
...
def is_pronounceable_spanish(word: str) -> bool:
    ...
    if low in {
        "eye", "beyn", "sayss", "today", "noun", "casual", "without", "monday",
        "restaurant", "weather", "children", "friend", "same", "both", "please",
        "thanks", "hello", "goodbye", "yes", "maybe", "never", "always", "often",
        "here", "there", "where", "when", "what", "who", "why", "how", "which",
        "because", "before", "after", "under", "over", "between", "through",
        "preview", "editor", "window", "reload", "click", "press", "section",
        "sections", "example", "examples", "note", "notes", "tip", "tips",
        "english", "latin", "america", "castilian", "sheet", "file", "folder",
        "style", "styles", "margin", "padding", "layout", "spacing", "format",
        "highlight", "underline", "yellow", "triangle", "triangles", "chevron",
        "details", "summary", "markdown", "developer", "workspace", "setting",
        "value", "currently", "content", "title", "pattern", "sound", "letter",
        "word", "phrase", "sentence", "meaning", "person", "people", "place",
        "time", "date", "number", "month", "week", "day", "year", "hour",
        "gender", "verb", "noun", "adjective", "pronoun", "article", "adverb",
        "preposition", "conjunction", "singular", "plural", "masculine",
        "feminine", "formal", "informal", "present", "past", "future",
        "default", "optional", "important", "common", "useful", "basic",
        "advanced", "beginner", "learner", "practice", "review", "reference",
        "guide", "table", "column", "row", "filter", "freeze", "sheet",
        "workbook", "excel", "csv", "pdf", "print", "export", "import",
    }:
        return False
...
def link_attrs(url: str, title: str) -> str:
    ...
    return (
        f'href="{url}" target="{PLAYER_TARGET}" rel="noopener" '
        f'title="{title}"'
    )
...
_FUNCTION_WORDS = {
    "el", "la", "los", "las", "de", "del", "a", "al", "en", "y", "o", "u", "e",
    "un", "una", "unos", "unas", "por", "para", "con", "sin", "que", "qué",
    "se", "me", "te", "nos", "os", "lo", "le", "les", "su", "mi", "tu", "sus",
    "mis", "tus", "es", "son", "ser", "estar", "yo", "tú", "él", "ella", "usted",
    "si", "sí", "no", "ya", "muy", "más", "tan", "como", "cuando", "donde",
    "cómo", "dónde", "cuándo", "quién", "cuál", "y", "e", "ni", "mas", "pero",
}
...
def is_real_phrase(words: list[str]) -> bool:
    ...
    content = [
        w
        for w in words
        if w.lower() not in _FUNCTION_WORDS and len(w) >= 3
    ]
...
def _inject_phrases_in_segment(segment: str) -> tuple[str, int]:
    ...
    for group in reversed(groups):
        ...
        result = (
            result[:start]
            + f'<span class="phrase">{run}{btn}</span>'
            + result[end:]
        )
        count += 1
    return result, count
